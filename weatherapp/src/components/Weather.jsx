...
// import { ReactComponent as SearchIcon } from '../assets/search_one.svg'
...
const Weather = () => {
    ...
    <div className='w-screen h-screen flex items-center justify-center bg-slate-600'>
        <div className=' w-[400px] h-[500px] p-4 shadow-xl items-center rounded-xl' style={{ backgroundColor: backgroundColor }}>
            <div className='flex gap-4 items-center justify-center w-[350px]'>
                <form className='flex gap-4 items-center justify-center p-4 ' onSubmit={handleSearch}>
